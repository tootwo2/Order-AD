package com.topsports.tootwo2.widget.autolistview.widget;
...
import com.topsports.tootwo2.widget.autolistview.utils.Utils;
	...
	private void refreshHeaderViewByState() {
		switch (state) {
			case NONE:
				...
				arrow.setImageResource(R.drawable.autolistview_pull_to_refresh_arrow);
				break;
			case PULL:
